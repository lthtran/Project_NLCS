...
$db_name="aliasstore";
try{
$pdo = new PDO("mysql:host=$host;database=$db_name",$name,$pass);
...
<body>
    <?php
    try{
        $sql = "SELECT product_id,COUNT(product_id) AS size_status FROM aliasstore.pending_orders GROUP BY product_id";
