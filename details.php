                        ...
                        <div class="box">
                            <h1 class="text-center"> <?php echo $pro_title; ?> </h1>
                                ...
                                <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post">
                                    ...
                                    <p class="text-center button"><button class="btn btn-primary i fa fa-shopping-cart">Thêm vào giỏ hàng</button></p>
                        ...
                        <div class="row" id="thumbs">
                            ...
                            <div class="col-xs-4">
                                <a data-target="#myCarousel" data-slide-to="1" href="#" class="thumb">
                                    <img src="./admin_area/product_images/<?php echo $pro_img2; ?>" alt="Product 1a" class="img-responsive">
                                </a>
                            </div>

                            <div class="col-xs-4">
                                <a data-target="#myCarousel" data-slide-to="2" href="#" class="thumb">
                                    <img src="./admin_area/product_images/<?php echo $pro_img3; ?>" alt="Product 1b" class="img-responsive">
                                </a>
                            </div>
                        </div>
                ...
                <div class="box" id="details">
                    ...
                    <h4>Khác</h4>
                        <ul style="list-style: none;">
                            ...
                            <li><i class='fa fa-check-square'></i> Hàng chính hãng 100%</li>
                            <li><i class='fa fa-car'></i> Miễn phí vận chuyển</li>
                        </ul>
                        <hr>
                </div>
